        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg prose-invert mx-auto space-y-8">
            ...
            <p className="font-grotesque text-lg text-foreground/80 leading-relaxed text-justify max-w-3xl mx-auto">
              Em Vitória da Conquista, terra do cineasta, o aeroporto leva o nome de <span className="italic">Aeroporto Glauber Rocha</span>, o teatro da UESB é o <span className="italic">Teatro Glauber Rocha</span>. Tem a <span className="italic">Casa Glauber Rocha</span>. “É tudo Glauber Rocha nesses espaços físicos", pontua Daniel Leite. No entanto, o <a href="https://www.youtube.com/watch?v=bKRvfyjPofQ" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">Cine Madrigal</span></a>, histórico cinema de rua fundado em 1968, está fechado e sem expectativas de recuperação. Ali ocorreu a pré-estreia de <a href="https://www.youtube.com/watch?v=KE7cAxMN_tc" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">Central do Brasil</span></a>, com a presença de Walter Salles, como lembra o diretor.
            </p>
