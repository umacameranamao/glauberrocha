                        ...
                        <div className="space-y-12">
                            <div ref={audioTriggerRef} className="max-w-3xl mx-auto space-y-6">
                                <p className="font-grotesque text-lg text-foreground/80 leading-relaxed text-justify">
                                    Por décadas, a Bahia se orgulhou de ter criado um cineasta reconhecido mundialmente. O que poucos sabem é que ele também deixou uma vasta produção literária. A coletânea <a href="https://www.estantevirtual.com.br/busca/poemas-eskolhydos-de-glauber-rocha" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">‘Poemas Eskolhydos de Glauber Rocha’</span></a>, organizada por Pedro Maciel, reúne os versos mais conhecidos do autor, enquanto <a href="https://www.amazon.com.br/Cartas-ao-mundo-Glauber-Rocha/dp/8571646880" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">‘Cartas ao Mundo’</span></a>, organizada por Ivana Bentes, revela seu pensamento por meio de correspondências pessoais. O próprio Glauber defendia que seus textos fossem publicados como forma de “preservar a base literária de seus filmes”.
                                </p>
                                ...
                                <p className="font-grotesque text-lg text-foreground/80 leading-relaxed text-justify">
                                    Glauber se apropriou da tradição oral nordestina, especialmente da literatura de cordel, em <a href="https://www.youtube.com/watch?v=QEsoB05RjGs" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">Deus e o Diabo na Terra do Sol (1964)</span></a> e <a href="https://youtu.be/MTcN0jo7IpU?si=4hTHyv8xl0ih5NdY" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">O Dragão da Maldade contra o Santo Guerreiro (1969)</span></a>, levando para o cinema uma cadência marcada por rimas, proclamações e discursos populares. Em Deus e o Diabo, por exemplo, a parceria com Sérgio Ricardo, compositor e figura emblemática do <a href="https://pt.wikipedia.org/wiki/Cinema_Novo" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">Cinema Novo</span></a>, transformou os poemas originais do cineasta nas canções que conduzem a história.
                                </p>
                                <p className="font-grotesque text-lg text-foreground/80 leading-relaxed text-justify">
                                    Décadas depois, os versos do diretor ganharam vida também na voz de outro conquistense, o compositor Gutemberg Vieira. Encarnando a figura de um verdadeiro ‘menestrel’ moderno, aquele que, no sertão, guarda e transmite a identidade cultural de seu povo, ele transformou os poemas do cineasta em cerca de 14 faixas gravadas em estúdio profissional. Sua qualidade técnica e poética é frequentemente comparada à de gigantes como <a href="https://pt.wikipedia.org/wiki/Elomar" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">Elomar</span></a> e <a href="https://pt.wikipedia.org/wiki/Xangai_(m%C3%BAsico)" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">Xangai</span></a>, ainda que Gutemberg não tenha alcançado a mesma projeção comercial.
                                </p>
                                ...
                                <p className="font-grotesque text-lg text-foreground/80 leading-relaxed text-justify">
                                    Mesmo restrito, as interpretações revelam a força dos versos. Por exemplo, a poesia “Letra Fera”, descrita como um “vômito de ideias”, ganhou interpretação inédita dos artistas Tarcísio Santos e Guigga Maraká e integrou o álbum <a href="https://www.instagram.com/marsobrepedras?igsh=MTM5dDRzZ2M4M2c4eA==" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">“Mar Sobre Pedras” (2023)</span></a> da dupla. Segundo Gutemberg, a leitura “deu outra roupa para o manequim”.
                                </p>
                            </div>
                        ...
                        <div className="space-y-8">
                            <div className="max-w-3xl mx-auto text-justify space-y-6">
                                <div className="prose prose-lg prose-invert">
                                    <p className="font-grotesque text-lg text-foreground/80 leading-relaxed text-justify">
                                        Em tempos de produções cheias de efeitos sonoros e retoques digitais, Guigga e Tarcísio seguiram o caminho oposto. O álbum foi gravado ao vivo, em estúdio, apenas com voz e violão. A decisão nasceu do bolso curto, é verdade, mas também de uma escolha estética: fazer arte com o que se tem, um princípio que lembra o <a href="https://pt.wikipedia.org/wiki/Cinema_Novo" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">Cinema Novo</span></a> de Glauber. “É essa coisa da câmera na mão e uma ideia na cabeça... o violão na mão e uma voz falando”, aponta Tarcísio.
                                    </p>
