          ...
          <div className="max-w-4xl mx-auto mb-16 text-left space-y-6">
            <div className="prose prose-lg prose-invert mx-auto">
              ...
              <p className="font-grotesque text-lg text-foreground/80 leading-relaxed text-justify max-w-3xl mx-auto mb-8">
                A <a href="https://www.gov.br/secom/pt-br/acesso-a-informacao/comunicabr/lista-de-acoes-e-programas/lei-paulo-gustavo" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">Lei Paulo Gustavo</span></a>, criada por meio da Lei Complementar nº 195, em 08 de julho de 2022, permitiu que cidades sem políticas culturais próprias, ou que nunca acessaram o <a href="https://www.gov.br/ancine/pt-br/fsa/institucional/sobre-o-fsa" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">Fundo Setorial do Audiovisual (FSA)</span></a>, passassem a financiar filmes produzidos localmente, como é o caso do cineasta Pedro Rodrigues, que revela que a lei foi a possibilidade de produzir o seu documentário <a href="https://drive.google.com/file/d/1Xb4uy1m7QArWS1JScYOX-I8MQb-oaDCJ/view?pli=1" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">“DIA 11”</span></a>, obra que fala sobre a explosão da fábrica de fogos, ocorrida no dia 11 de dezembro de 1998 em Santo Antônio de Jesus.
              </p>
              ...
              <p className="font-grotesque text-lg text-foreground/80 leading-relaxed text-justify max-w-3xl mx-auto mb-8">
                Em 2022, quando finalmente chegou à <a href="https://www.instagram.com/mostracinemaconquista?igsh=MTVtNHRrd3lkdW5ydQ==" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity"><span className="italic text-primary">Mostra Cinema Conquista</span></a>, festival organizado pela Universidade Estadual do Sudoeste da Bahia, o público precisou “sentar no chão”, segundo o diretor. “Quer sessão lotada? Passe filme que foi feito aqui!”, anuncia. O problema, diz ele, não é falta de interesse, mas as barreiras econômicas.
              </p>
              <p className="font-grotesque text-lg text-foreground/80 leading-relaxed text-justify max-w-3xl mx-auto mb-8">
